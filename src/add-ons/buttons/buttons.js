class Buttons {
    ...
    init() {
        ...
        this.accordion.addEventListener( 'pageScroll.' + this.namespace, ( event ) => {
            ...
            this.buttonsEl.getElementsByClassName( 'ga-selected' )[0].classList.remove( 'ga-selected' );
            this.buttonsEl.getElementsByClassName( 'ga-pagination-button' )[ event.detail.index ].classList.add( 'ga-selected' );
        });
    }
    ...
    updateHandler() {
        ...
        this.buttonsEl = this.accordion.accordionEl.getElementsByClassName( 'ga-pagination-buttons' )[0];
        ...
        if ( this.settings.buttons === true && totalPages > 1 && typeof this.buttonsEl === 'undefined' ) {
            this.createButtons();
        } else if ( this.settings.buttons === true && typeof this.buttonsEl !== 'undefined' && totalPages !== this.buttonsEl.getElementsByClassName( 'ga-pagination-button' ).length ) {
            this.adjustButtons();
    ...
    createButtons() {
        ...
        this.accordion.accordionEl.classList.add( 'ga-has-buttons' );
    }
    ...
    // Remove the buttons
    removeButtons() {
        Array.from( this.buttonsEl.getElementsByClassName( 'ga-pagination-button' ) ).forEach( ( buttonEl, index ) => {
        ...
        this.accordion.accordionEl.classList.remove( 'ga-has-buttons' );
    }
